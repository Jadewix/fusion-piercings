...
// We keep the dot gradients for the design, but remove the big background gradients
...
export default function ProductCard({ product, onOpenModal }: Props) {
  ...
  return (
      <article
          className="bg-bg-card border border-border-lt rounded-sm shadow-sm hover:shadow-md hover:-translate-y-1 hover:border-border transition-all duration-300 cursor-pointer overflow-hidden group flex flex-col"
      ...
      >
        ...
        <div className="p-4 flex flex-col flex-grow">
          ...
          <div className="flex items-center justify-between mt-auto">
            ...
            {/* Your friend's elegant metal indicator dot */}
            <span
