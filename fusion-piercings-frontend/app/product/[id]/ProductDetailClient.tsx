...
// Old rows might still have sizes as string[]; coerce to ProductSize[].
...
export default function ProductDetailClient({ productId }: Props) {
  ...
  function handleAdd() {
    ...
    addToCart(product, selectedSize, isBothMetal ? selectedMetal : undefined);
  }
    ...
    <div className="max-w-[1100px] mx-auto px-4 sm:px-8 py-10 sm:py-14">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16">
        ...
        <div className="flex flex-col">
          ...
          {/* Size selector — boxed buttons with strikethrough for out-of-stock */}
          <div className="mb-8">
            <p className="text-[0.7rem] font-semibold tracking-[0.16em] uppercase text-ink-2 mb-3">
              Size
            </p>
